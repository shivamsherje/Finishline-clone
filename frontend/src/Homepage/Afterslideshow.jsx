...
const Afterslideshow = () => {
  return (
    <div className="Afterslideshow" style={{  width:"80%", margin:"auto", display:"flex" , padding:"30px", textAlign:"center",justifyContent:"center", marginTop:"30px", marginBottom:"30px"}}>
